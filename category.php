...
<?php include('include/nav.php'); ?>
    ...
    if ($res -> num_rows === 1) {
        $resPost = $res -> fetch_assoc()
            ...
            ?>  
                    <li class="header__item"><a href="" class="header__link"><?=$resPost['name']?></a></li>
                 <?php } ?>
                </ul>
            </div>
    ...
    <section class="proect">
        <div class="container">
            ...
            <?php 
				...
				$sql = "SELECT t1.id AS postid, t1.image, t1.likes, t1.glass, t2.image AS userimage, 
                t2.name AS username, t3.id, t3.name  AS category 
                FROM project t1 
			...
			?>
                <div class="col-4 proect__item">
                    <a href="article.php?id=<?= $resArticle['postid'] ?>" class="proect__border"><img class="proect__img" src="uploads_images/<?= $resArticle['image'] ?>" alt=""></a>
